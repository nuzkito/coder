...
namespace App\Prism\Providers\LmStudio\Handlers;

use App\Prism\Providers\LmStudio\Concerns\MapsFinishReason;
use App\Prism\Providers\LmStudio\Concerns\ValidatesResponses;
use App\Prism\Providers\LmStudio\Maps\MessageMap;
use App\Prism\Providers\LmStudio\Maps\ToolCallMap;
use App\Prism\Providers\LmStudio\Maps\ToolChoiceMap;
use App\Prism\Providers\LmStudio\Maps\ToolMap;
...
class Text
{
    ...
    public function handle(Request $request): TextResponse
    {
        ...
        return match ($this->mapFinishReason($data)) {
            ...
            default => throw new PrismException('LmStudio: unknown finish reason'),
        };
    }
